...
constexpr inline size_t kDataTypeGamepadInputStateSize = sizeof(gamepad::input::State) + 1;
#else
static constexpr size_t kDataTypeGamepadInputStateSize = sizeof(gamepad::input::State) + 1;
#endif
