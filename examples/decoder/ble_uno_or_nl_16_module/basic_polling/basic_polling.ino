 ...
 *          both joysticks. It showcases the fundamental usage of `gamepad::input::Tracker[Button]` for discrete button queries
 *          and `gamepad::input::Tracker[Axis]` for continuous joystick readings.
